...
var NEXT_STEPS = [
  ...
  },
  {
    ...
    title:   'Practice your cuing voice',
    desc:    "You have the music. Now sharpen your verbal cues. The Cue Lab generates Verb / Body Part / Direction combinations so you can practice fast, specific language.",
    href:    'v-ybp-d.html',
    label:   'Open Cue Lab',
  },
  {
    trigger: 'story-structure.html',
    title:   'Give the story a constraint',
    desc:    "You've been working on story structure. Add a physical rule to deepen the class experience and force creative problem-solving.",
    href:    'arbitrary-rule-generator.html',
    label:   'Generate a Rule',
  },
  {
    trigger: 'v-ybp-d.html',
    title:   'Put it into shorthand',
    desc:    "You've been practicing your cues. Write them down using Flow School shorthand so you can track and recall sequences over time.",
  ...
  },
  {
    ...
    title:   'Take it into a class arc',
    desc:    "You've been working on breath pacing. Now build a class where the breath pattern sets the structure from warmup to close.",
    href:    'story-structure.html',
